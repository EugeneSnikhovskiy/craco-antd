...
const overrideWebpackConfig = ({ context, webpackConfig, pluginOptions }) => {
  ...
  // original repo is dead https://github.com/dr2009/craco-less
  // if craco-antd updated - don't forget delete local craco-less
  const CracoLessPlugin = require("./fixes/craco-less/lib/craco-less");
  const modifyVars = {};
